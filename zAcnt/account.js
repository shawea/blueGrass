var Login = (function () {
    ...
    Login.prototype._transition = function (transEnum, ctx) {
    };
    Login.prototype._onLoaded = function (guid) {
        console.log('READY');
    ...
    Login.prototype._onLoginClicked = function () {
        console.log('login ');
    ...
    Login.prototype._onRetLogin = function (data_, errorString) {
        console.log('L');
    ...
    Login.prototype._onSignupClicked = function () {
        console.log('signup ');

        var full_name = $('#signup-name').val();
        ...
        var pswd = $('#signup-pass').val();
        var pswd2 = $('#signup-pass2').val();
    ...
    Login.prototype._onSignUpRet = function (data_, errorString) {
        console.log('S');
        console.log(JSON.stringify(data_));
        if (errorString) {
            console.log(errorString);
...
var Profile = (function () {
    ...
    Profile.prototype._transition = function (transEnum, ctx) {
        forward('profile', 'profile', this._onLoaded);
    };

    Profile.prototype._onNewApp = function () {
        var msg = new Object();
    ...
    Profile.prototype._onLoaded = function (guid) {
        console.log('profile');
        cleanUpViews();
    ...
    Profile.prototype._onRowRet = function (data_) {
        $('#app_name').text(data_.app_name);
        $('#secret_app_key').text(data_.secret_app_key);
    };

    Profile.prototype._getApps = function () {
        var msg = new Object();
        msg.account_id = app.accData._id;
        app.cloudAPI._call('ListApps', msg, app._profile._onRet, null);
    };
    Profile.prototype._onRet = function (data_) {
        app.appsData = data_;
